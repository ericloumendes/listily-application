...
export const supermercadoController = {
    save: async (req: Request, res: Response) => {
        try {
            ...
            const novoSupermercado = await Supermercado.create({ nome, endereco });
    ...
    update: async (req: Request, res: Response) => {
        try {
            ...
            await supermercado.update({ nome: nome || supermercado.nome, endereco: endereco || supermercado.endereco });
